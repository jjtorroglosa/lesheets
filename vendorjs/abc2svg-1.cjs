...
function js_inject(js){(0,eval)('"use strict";\n'+js)}
...
xx+=10
spf=(width-xs-xse)/(xx-xse)}else if(cfmt.trimsvg){spf=1-cfmt.maxshrink}else{spf=spf_last
